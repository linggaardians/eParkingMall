...
<nav>
  ...
  <!-- <div class="menu-icons-container">
    <img src="./assets/resource/Search.svg" alt="" class="icon"> 
    <img src="./assets/resource/Profile.svg" alt="" class="icon"> 
    <img src="./assets/resource/Cart.svg" alt="" class="icon"> 
 </div> -->
...
if (isset($_SESSION['customer_id'])) {
   ...
   if (mysqli_num_rows($reservationResult) > 0) {
    ...
    $result = mysqli_query($con, $sql);
       ...
       echo '<img style="margin-bottom: 25px;" src="./assets/resource/warning.svg" alt="Image">';
       ...
       if ($remaining > 0) {
           ...
           ?>
           <div class="ill" >
    <img src="./assets/resource/card.svg">
</div>
        ...
        echo '<div style="display: flex; flex-direction: column; justify-content: center; align-items: center; height: 100vh;">';
        echo '<img style="margin-bottom: 25px;" src="./assets/resource/empty.svg" alt="Image">';
