  ...
  <style>
    * {
    ...
    td {
      padding: 12px;
      text-align: center;
      /* Center align both th and td */
      width: 33.33%;
      /* Divide the width equally for three columns */
...
<body>
  ...
  <header>
    <div class="logohd"><a href="ownerhome.php">eParking Mall </a></div>
    <nav>
      <?php
  ...
  <?php
        ...
        if ($type === 'monthly') {
          ...
          echo '<img style="margin-bottom: 25px;" src="./assets/resource/monthly.svg" alt="Image">';
      ...
      echo '<img style="margin-bottom: 25px;" src="./assets/resource/invalid.svg" alt="Image">';
