...
<header>
  <div class="logohd">
    <a href="admin.php">eParking Mall </a>
  </div>
  <nav>
    <?php
    if (isset($_SESSION['email'])) {
      echo '<a href=""><img style="width:30px; height:30px;" src="./assets/resource/Account circle.svg" alt="Add"></a>';
...
<main>
  <div class="admin-section">
    <div style="text-align: center;">
      <a href="#"><img src="./assets/resource/Group 35.svg" alt="log out"></a><br>
    </div>
    ...
    <div class="suspend-user">
      <h4 style="text-align: left; margin-left:-600px; padding-left:0;">Suspend a User</h4>
    ...
    <div class="suspend-parking-owner">
      <h4 style="text-align: left; margin-left:-525px; padding-left:0;">Suspend a Parking Owner</h4>
      <div style="display: flex; align-items: center;">
        <form action="" method="post">
