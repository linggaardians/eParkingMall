...
<body>
    <header>
        <div class="logohd">eParking Mall</div>
        <div class="header-center">
            <h2 class="Headtext">Cari, Booking, Bayar, Parkir, Mudah!</h2>
    ...
    <section class="discover">
        <div class="container">
            <div class="discover-text">
                <img src="./assets/resource/Discover.svg" alt="Discover Image" width="506" height="466">
                <div class="discover-content">
                    ...
                    <p>Temukan tempat parkir di mana saja, untuk saat ini atau nanti<br>
                    Bandingkan harga & pilih tempat yang terbaik untuk Anda</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="discover-text">
                <div class="discover-content">
                    ...
                    <p>Pesan tempat hanya dengan beberapa klik<br>
                    Tidak ada lagi waktu yang terbuang untuk Anda</p>
                </div>
                <img src="./assets/resource/Time.svg" alt="Time Image" width="506" height="466">
    ...
    <section class="owner">
        <div class="container">
            <div class="discover-text">
                <img src="./assets/resource/Owner.svg" alt="Discover Image" width="506" height="466">
                <div class="discover-content">
                    <h2>
                        Parking Owner ?
                    </h2>
                    <p>Join dengan Kami dan buat Parkir Mall
                        Anda menjadi lebih efisien</p>
