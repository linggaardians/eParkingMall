...
<head>
  ...
  <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
	...
	<link rel="stylesheet" href="./assets/ownerhome.css">
  <style>
...
<body>
	<header>
		<div class="logo">eParking Mall</div>
    ...
    if (isset($_SESSION['email'])) {
      ...
      echo '<a href="logout.php"><img style="width:30px; height:30px;" src="./assets/resource/Logout.svg" alt="Add"></a>';
    } else {
     ...
     ?>
      <section class="upper-section">
        ...
        <div class="Hourly-spots">
            ...
            <button name="addhourly" class="hourly-add-btn">Add a Spot<img src="./assets/resource/Plus (Traced).svg"></button>
		</form>
        </div>
		<div class="Hourly-booked">
            ...
            <button name="removehourly" class="hourly-remove-btn">Remove a Spot<img src="./assets/resource/Minus Sign (Traced).svg"></button>
		</form>
        </div>
  <?php  } 
        $monthly_spot= "SELECT `spots`, `spots_booked` FROM `parking_spot` WHERE `owner_id` = {$_SESSION['owner_id']} AND `type` = 'monthly' ";
	  ...
	  <section class="lower-section">
        ...
        <div class="monthly-add">
            ...
            <button name="addmonthly" class="monthly-add-btn">Add a Spot<img src="./assets/resource/Plus (Traced).svg"></button>
		</form>
        </div>
		<div class="monthly-remove">
            ...
            <button name="removemonthly" class="remove-btn">Remove a Spot<img src="./assets/resource/Minus Sign (Traced).svg"></button>
		</form>
        </div>
      </section>
