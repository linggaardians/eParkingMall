...
<head>
  ...
  <style>
    ...
    .menu .submenu {
      ...
      position: absolute;
      top: 80%;
      /* Adjust the top position as per your preference */
      left: 50%;
      ...
      z-index: 1;
      overflow: visible;
      /* Allow content overflow to be visible */
...
<body>
  ...
  <main>
    <img src="./assets/resource/contact.svg" alt="Contact Us">
    <h1>Contact Us</h1>
    <div style="
    position: relative; padding: 235px; top:120px;">
      <a href="mailto:eParkingMall@gmail.com" style="position: absolute;left: 154px;top: 13px;text-decoration: none;color: #010101;font-size: 24px;">   eParkingMall@gmail.com</a>
      <i class="fa-solid fa-envelope" style="color: #007c51;font-size: 60px;position: absolute;top: -1px;left: 72px;"></i>
      <a href="https://wa.me/+6281211199999" target="_blank" style="position: absolute;margin-left: -87px;top: 120px;font-size: 24px;text-decoration: none;color: #010101;">+62 812-1119-9999</a>
      <i class="fa-brands fa-whatsapp" style="color: #007c51;font-size: 60px;position: absolute;left: 78px;top: 106px;"></i>
    </div>
  </main>
  <footer>
    <div class="container">
