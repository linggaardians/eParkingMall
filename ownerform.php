...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Ubuntu&display=swap" rel="stylesheet">
        <link rel="stylesheet" href="./assets/ownerform.css">
...
<body>
    <header>
        <div class="logo"> <a href="home.php"> eParking Mall </a></div>
        <nav>
        <?php
        if (isset($_SESSION['email'])) {
            echo'<a href=""><img src="./assets/resource/Account circle.svg" alt="Add"></a>';
  ...
  <img id="poill" src="./assets/resource/poill.svg" alt="parkingowner">
</div>
    <div class="container">
